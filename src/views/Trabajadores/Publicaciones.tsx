    ...
    <View style={tw`flex-1 bg-gray-50`}>
      ...
      >
        <View style={tw`flex-1 bg-black bg-opacity-50 justify-end`}>
          <View style={tw`bg-white rounded-t-lg p-5`}>
            ...
            <View style={tw`flex-row justify-end space-x-3`}>
              <TouchableOpacity
                style={tw`py-2 px-4 bg-gray-200 rounded-lg`}
                onPress={() => setAddModalVisible(false)}
              >
                <Text style={tw`text-gray-700`}>Cancelar</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={tw`py-2 px-4 bg-blue-600 rounded-lg`}
                onPress={addNewPost}
              >
